...
export default function TaskRow({ task, cardItem }) {
  ...
  // dispatch for getting alltasks (send card id)
  // useSelector(state=>state.tasks.task)
  ...
  return (
    task && (
      <div>
        ...
        >
          <div
            className="hover:bg-gray-200 flex justify-between rounded-xl shadow-[0_1px_2px_rgb(0_0_0_/0.2)] bg-[#f6f5fa]   p-4 w-full mx-5 my-2 h-fit"
            // onClick={() => {
            //   setOpen(true);
            // }}
          >
            <div className="flex justify-between flex-col w-full ">
              ...
              <p className="font-light text-s">{mockData.name}</p>
              <div className="w-100 h-10 flex items-end gap-5 text-gray-600">
                <div className="flex gap-2">
                  <i class="fa-regular fa-clock "></i>
                  <p className="font-light text-xs">{mockData.date}</p>
                </div>
